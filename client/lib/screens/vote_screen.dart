  ...
  Future<void> _submit() async {
    ...
    if (_president == null) {
      await Utils.showDefaultDialog(
        context: context,
        content: 'Escolha um candidado para presidente.',
      );
    ...
    if (_mayor == null) {
      await Utils.showDefaultDialog(
        context: context,
        content: 'Escolha um candidado para prefeito.',
      );
    ...
    if (position == null) {
      if (mounted) {
        await Utils.showDefaultDialog(
          context: context,
          content:
              'Habilite ou permita o acesso do aplicativo ao serviço de localização do dispositivo e tente novamente.',
        );
      }
                    ...
                    listener: (context, state) async {
                      if (state is SubmitVoteErrorState) {
                        ...
                        await Navigator.of(context)
                            .pushReplacementNamed(PostVoteScreen.route);
                      }
                    },
                    child: Form(
                      key: _formKey,
